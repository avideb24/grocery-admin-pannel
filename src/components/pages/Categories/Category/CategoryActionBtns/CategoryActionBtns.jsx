...
const CategoryActionBtns = ({ category, mainCategoryId }) => {
    ...
    const handleAddCategory = async (e) => {
        ...
        const res = await axiosPublic.patch(`/api/category/update/${category?.id}`, formData, {
            headers: {
    ...
    const handleDelete = async (categoryId) => {
        ...
        if (result.isConfirmed) {
            try {
                const res = await axiosPublic.delete(`/api/category/remove/${categoryId}`);
        ...
        <div className='flex justify-center items-center gap-2 md:gap-5'>
            ...
            <dialog id={`my_modal_${category?.id}`} className="modal">
                <div className="modal-box bg-primary-bg dark:bg-secondary-bg text-primary-text dark:text-secondary-text">
                    ...
                    <h2 className='text-center text-base md:text-lg font-bold border-b border-b-slate-300 dark:border-b-slate-500 pb-1 mb-4'>Update Category</h2>
...
export default CategoryActionBtns;
